...
```
NEXT_PUBLIC_QURAN_FOUNDATION_CLIENT_ID=
QURAN_FOUNDATION_CLIENT_SECRET=
NEXT_PUBLIC_QURAN_FOUNDATION_REDIRECT_URI=
NEXT_PUBLIC_QURAN_API_BASE_URL=https://api.qurancdn.com/api/qdc
NEXT_PUBLIC_QURAN_USER_API_BASE_URL=https://api.quran.foundation
```
