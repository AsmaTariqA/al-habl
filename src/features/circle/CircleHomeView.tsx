  ...
  return (
    <AppShell pageLabel="Circle" rightPanel={rightPanelContent}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        {!loading && !room ? (
          <div style={{ padding: '4rem 2rem', textAlign: 'center', height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '1rem', color: 'var(--text)' }}>No Circle Found</h2>
            <p style={{ color: 'var(--muted)', marginBottom: '2rem' }}>You haven&apos;t joined a circle yet, or your circle couldn&apos;t be loaded.</p>
            <button onClick={() => router.push('/onboarding')} className="button-primary">Join a Circle</button>
          </div>
        ) : (
          <>
            {/* Mobile header */}
