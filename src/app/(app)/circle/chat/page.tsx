                    ...
                    >
                      ...
                      {mine && (
                        <button
                          ...
                          className="absolute -top-2 -right-2 hidden group-hover:flex items-center justify-center w-7 h-7 rounded-full bg-[var(--gold)] text-white text-xs"
                        >
                          🗑
                        </button>
                      )}
